...
- A named author persona / pen name and a first-person editorial voice are allowed. What is NOT allowed is fabricating a verifiable professional CREDENTIAL: never invent a license number (e.g. "LFD #4471"), and never present the author as holding a specific license or certification (e.g. "Licensed Funeral Director", "board-certified", "CFP") unless that is real and supplied to you. This applies in the visible text AND in the JSON-LD — do not give a Person "author" a "jobTitle"/credential you made up; use the brand/organization as the author, or a plain name with no credential. A persona may share general first-hand-style perspective, but must not claim a fake license, certification, or regulatory status.
